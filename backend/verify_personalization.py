...
def run_verify():
    ...
    report_path = r"C:\Users\Radhika Patange\?.gemini\antigravity-ide\brain\2fe6cffe-c03d-4ee9-86b2-0983a38179d1\personalization_audit_report.md".replace("?", ".temp").replace(".temp", "")
    # Note: we construct the path as literal to avoid escaping bugs
    report_path = "C:\\Users\\Radhika Patange\\.gemini\\antigravity-ide\\brain\\2fe6cffe-c03d-4ee9-86b2-0983a38179d1\\personalization_audit_report.md"
