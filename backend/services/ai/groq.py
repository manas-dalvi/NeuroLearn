    ...
    def _build_system_instruction(self, profile_type: str, reading_level: str) -> str:
        ...
        if profile_type.lower() == "adhd":
            ...
            return (
                ...
                "3. To maintain at least 90% of the original text's word count, you must NOT summarize or compress. You must rewrite the entire detailed content of the original paragraph using a larger number of short, simple sentences (typically at least 9 to 12 sentences for long paragraphs, but for short paragraphs or documents under 100 words, use fewer sentences like 2 to 5 sentences to avoid artificial expansion, repetition, or fluff). You must expand on all explanations and facts from the original paragraph rather than summarizing them, but do not repeat information or sentences. For example, explain the difference between dense and sparse representations, describe neocortex layers, and elaborate on how Hebbian learning works, all using simple, short sentences.\n"
